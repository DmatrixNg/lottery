...
<div class="col">
                      ...
                      <div class="form-label-group">
                        ...
                        <input type="text" id="Mname" name="Mname" class="form-control" placeholder="Lastname" required="" value="<?php if (isset($_GET['back']) && $_GET['back'] == 1 && $_SESSION['reg1']=="ready") {echo $r['Mname'];} ?>" autofocus="">
