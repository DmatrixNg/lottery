...
if (isset($_POST['Next']) && $_SESSION['reg1'] == "ready") {
 ...
 //}
  ...
  $stmt=$db->prepare('INSERT into clients (fname,lname,email,Mname,password,age,gender,contact,date_of_birth,address)
  VALUES (:fname,:lname,:email,:Mname,:password,:age,:gender,:contact,:date_of_birth,:address) ');
  $stmt->execute(
  array(
    ':fname' => $fname,
    ':lname' =>$lname ,
      ...
      <div class="col">
                    ...
                    <div class="form-group">
                      <div class="form-label-group">
                        ...
                        <select name='gender' id='inputGen' value="<?php if (isset($_GET['back']) && $_GET['back'] == 1 && $_SESSION['reg1']=="ready") {echo $r['gender'];} ?>" class="form-control custom-select" required="">
